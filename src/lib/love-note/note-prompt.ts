...
export function noteSystemPrompt(instructions: string): string {
  return [
    SPANISH_RULE,
    'You write short chat messages from the author to their girlfriend. Everything you need to know about her, and about how the author talks to her, is below.',
    '',
    '=== Standing instructions ===',
    instructions,
    '=== end ===',
    '',
    `Write exactly ${NOTE_VARIANT_COUNT} messages. Each is 2 to 5 sentences: a chat message, not a letter.`,
    'Plain text only: no subject line, no greeting-and-signature block, no markdown, no lists.',
